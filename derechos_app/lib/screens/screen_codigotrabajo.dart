...
class PantallaPDFCodigoTrabajo extends StatelessWidget {
  const PantallaPDFCodigoTrabajo({super.key});
  ...
  final String urlPDF =
      'http://app.capacitacioncontinua.info/uploads/pdfs/codigotrabajo.pdf';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: const Text('Código del Trabajo')),
      ...
      body: FutureBuilder<bool>(
        ...
        builder: (context, snapshot) {
          if (snapshot.connectionState == ConnectionState.waiting) {
            ...
            return const Center(
              child: Text('Error al cargar el PDF. Verifica la conexión.'),
            );
          } else {
